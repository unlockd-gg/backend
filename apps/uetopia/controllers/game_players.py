...
from apps.uetopia.models.game_players import GamePlayers
...
class GamePlayersController(BaseController):
    ...
    def list_by_gameKeyId_modified(self, gameKeyId, start_cursor=None,):
        query = self.model.query()
        query = query.filter(self.model.gameKeyId == gameKeyId)
    ...
    def list_locked_by_serverKeyId(self, locked_by_serverKeyId):
        query = self.model.query()
